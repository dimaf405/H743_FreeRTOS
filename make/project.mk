...
DIMA_SERIAL_CONTRACT_OBJECTS := \
	$(DIMA_APPLICATION_CONTEXT_OBJECT) \
	$(DIMA_APP_MAIN_OBJECT) \
	$(BUILD_DIR)/Dima/modules/mavlink/MavlinkParameters.o \
	$(DIMA_SERIAL_CONFIG_OBJECT) \
...
$(DIMA_MAVLINK_COMPONENT_METADATA_OBJECTS): DIMA_PRIVATE_INCLUDES += \
	$(DIMA_COMPONENT_GENERATED_INCLUDES)
$(DIMA_SERIAL_CONTRACT_OBJECTS): DIMA_PRIVATE_INCLUDES += \
	$(DIMA_SERIAL_GENERATED_INCLUDES)
...
$(DIMA_STM32_UART_RESOURCE_OBJECT): DIMA_PRIVATE_INCLUDES += \
	$(DIMA_BOARD_SERIAL_GENERATED_INCLUDES)
