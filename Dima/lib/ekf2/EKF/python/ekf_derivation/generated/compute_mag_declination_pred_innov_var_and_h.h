...
void ComputeMagDeclinationPredInnovVarAndH(const matrix::Matrix<Scalar, 22, 1>& state,
                                           const matrix::Matrix<Scalar, 21, 21>& P, const Scalar R,
                                           const Scalar epsilon, Scalar* const pred = nullptr,
                                           Scalar* const innov_var = nullptr,
                                           matrix::Matrix<Scalar, 21, 1>* const H = nullptr) {
  // Total ops: 22
  ...
  if (H != nullptr) {
    matrix::Matrix<Scalar, 21, 1>& _h = (*H);
