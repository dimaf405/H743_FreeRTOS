...
- ICM driver 配置加速度计 ±16 g、陀螺仪 ±2000 deg/s、ODR 8 kHz 和 10 样本高分辨率 FIFO watermark，以私有批次工作区完成整数域压缩、跨批均值及 clipping 统计，仅发布 `sensor_accel` 与 `sensor_gyro`；硬件 FIFO 读取、水位和采样率保持不变。
