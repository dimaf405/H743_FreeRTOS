##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Wed Jul 15 11:45:47 CST 2026]
##########################################################################################################################

ifneq ($(DIMA_BUILD_INTERNAL),1)
$(error Makefile is an internal CubeMX layer; run GNU Make through GNUmakefile)
endif
...
$(BUILD_DIR)/%.o: %.c Makefile | $(BUILD_DIR)
	$(CC) -c $(CFLAGS) $(DIMA_CUBEMX_LISTING_FLAG) $< -o $@
